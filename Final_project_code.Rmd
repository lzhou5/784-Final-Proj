...
author: "Laura Zhou, Shaina Mitchell, Peiyao"
date: "11/16/2017"
...
data.qnormcat0 <- normalize.quantiles(data.ncat1)
data.qnormcat <- t(data.qnormcat0)

# clustering with hclust and mclust
c <- clustering2(data.qnormcat0, "Quantile Normalized")
```

While the quantile normalization felt restrictive, it actually matched the clustering results of 'hclust' very well
